...
fenrir_m, _ = ff.fenrir_mv(key, lorenz, W_block, x0_block, theta, tmin, tmax, n_res,
                           ode_init['trans_state'], ode_init['var_state'],
                           trans_obs, var_obs, y_obs, interrogate=interrogate_kramer)
...
pd.DataFrame(obs).to_csv("lz_obs.csv")
...
#     lp = df.dalton(key, lorenz, W_block, x0, theta, tmin, tmax, n_res,
...
# figure.savefig('figures/lorenzpost3.pdf')
