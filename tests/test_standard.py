...
class TestKalmanTVGM(unittest.TestCase):
    ...
    def test_filter(self):
        ...
        mean_state_pred2, var_state_pred2, mean_state_filt2, var_state_filt2 = jax.jit(
            ktv.filter
        )(
            mean_state_past=mean_state_past,
            var_state_past=var_state_past,
    ...
    def test_smooth_mv(self):
        ...
        self.assertAlmostEqual(
            utils.rel_err(mean_state_smooth1[0], mean_state_smooth2), 0.0
        )
        self.assertAlmostEqual(
            utils.rel_err(var_state_smooth1[0, :, 0, :].squeeze(), var_state_smooth2),
            0.0,
        )
